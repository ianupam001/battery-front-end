                            ...
                            <div className="blog-details__content">
                                <div className="blog-details__user-and-meta">
                                    ...
                                    <ul className="blog-details__meta list-unstyled">
                                        <li>
                                            <Link href="#"><span className="icon-clock"></span>{post && new Date(post.createdAt).toLocaleDateString()}</Link>
                                        </li>
                                        <li>
                                            <Link href="#"><span className="icon-clock"></span>{post && (post.content.length / 1000).toFixed(0)} Min Read</Link>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="blog-details__tag-and-share">
                                    ...
                                    <div className="blog-details__share-box">
                                      ...
                                      <div className="blog-details__share">
                                          <Link href={`https://www.facebook.com/sharer/sharer.php?u=${postUrl}`} target="_blank">
                                              <span className="icon-facebook"></span>
                                          </Link>
                                          <Link href={`https://twitter.com/intent/tweet?url=${postUrl}&text=${postTitle}`} target="_blank">
                                              <span className="icon-xpa"></span>
                                          </Link>
                                          <Link href={`https://www.linkedin.com/sharing/share-offsite/?url=${postUrl}`} target="_blank">
                                              <span className="icon-link-in"></span>
                                          </Link>
                                          <Link href={`https://www.instagram.com/?url=${postUrl}`} target="_blank">
                                    ...
                                    <li>
                                      <div className="sidebar__post-image  object-cover">
                                          <img src={post && post.image}
                                            alt={post && post.title} className=' object-cover'/>
                                      </div>
                                      <div className="sidebar__post-content">
                                          <p className="sidebar__post-date">{post && new Date(post.createdAt).toLocaleDateString()}</p>
                                          <h3>
