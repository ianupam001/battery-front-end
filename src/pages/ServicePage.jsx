                        ...
                        <div className="service-details__left">
                            <div className="service-details__img">
                                <img  src={service && service.image}
                                      alt={service && service.title} className='p-3 max-h-[500px] w-full object-cover'
                                  />
                            </div>
                            <h1 className="service-details__title-1">{service && service.title}</h1>
                            <div
                              className='post-content'
                              dangerouslySetInnerHTML={{ __html: service && service.content }}
                            ></div>
                        </div>
                    </div>
                            ...
                            <div className="service-details__services-box">
                                ...
                                {recentServices &&
                                  recentServices.map((service) => 
                                    ...
                                    <li>
                                        <Link to={`/service/${service.slug}`}>{service.title}<span
