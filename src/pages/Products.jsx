                  ...
                  <ul className="popular-products-list clearfix">
                    <li>
                      <div className="popular-products-img">
                        <img
                          src="assets/images/shop/product-v1-sidebar-1.png"
                          alt="Awesome Image"
                        />
                      </div>
                      <div className="popular-products-content">
                        <h3>
                          <Link href="#">
                            Digital multimeters are superior to analog
                            multimeters
                          </Link>
                        </h3>
                        <h6>$20.00</h6>
                    ...
                    <li>
                      <div className="popular-products-img">
                        <img
                          src="assets/images/shop/product-v1-sidebar-2.png"
                          alt="Awesome Image"
                        />
                      </div>
                      <div className="popular-products-content">
                        <h3>
                          <Link href="#">
                            Air Conditioning Tonnage helps determine.
                          </Link>
                        </h3>
                        <h6>$40.00</h6>
                      </div>
                    ...
                    <li>
                      <div className="popular-products-img">
                        <img
                          src="assets/images/shop/product-v1-sidebar-3.png"
                          alt="Awesome Image"
                        />
                      </div>
                      <div className="popular-products-content">
                        <h3>
                          <Link href="#">
                            Helpful tools, insight, and encouragement
                          </Link>
                        </h3>
                        <h6>$18.00</h6>
                      </div>
