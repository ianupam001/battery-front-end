                        ...
                        <div className="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                            <div className="footer-widget__column footer-widget__about">
                                <div className="footer-widget__logo">
                                    <Link href="/"><img src="https://static.wixstatic.com/media/128eb4_3ced2d249b1445e0975e433ba3bdfd10~mv2.png/v1/fill/w_73,h_88,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/128eb4_3ced2d249b1445e0975e433ba3bdfd10~mv2.png"
                                            alt=""/></Link>
                                </div>
                                <p className="footer-widget__about-text">Get back on the road with our reliable car battery replacement services. Drive stress-free knowing your car battery is in top condition.
                                </p>
                                ...
                                <ul className="footer-widget__contact-list list-unstyled">
                                    <li>
                                        ...
                                        <div className="content">
                                            <p>Al Asayel Street - 160St Warehouse no. 2 - 318th Rd - near Al Ahli Driving school - Al Quoz Industrial Area 3 - Dubai</p>
                                        </div>
                                    </li>
                                    <li>
                                        <h3>Contact</h3>
                                        <div className="content">
                                            <p><Link href="tel:+971509344668">+971 50 934 4668</Link></p>
                                            <p><Link href="mailto:support@800bbattery.com">support@800bbattery.com</Link></p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
            ...
            <div className="site-footer__bottom">
                <div className="container">
                    <div className="site-footer__bottom-inner">
                        <p className="site-footer__bottom-text">© 2024 by Barcode Auto Care LLC. All rights reserved.</p>
