            ...
            <div className="mobile-nav__wrapper">
                ...
                <div className="mobile-nav__content">
                    ...
                    <div className="logo-box">
                        <Link to={`/`}  aria-label="logo image"><img src="assets/images/resources/logo-1.png" width="150" alt="" /></Link>
                    </div>
                    ...
                    <ul className="mobile-nav__contact list-unstyled">
                        <li>
                            ...
                            <Link href="mailto:support@800bbattery.com">support@800bbattery.com</Link>
                        </li>
                        <li>
