          ...
          <SwiperSlide>
            <div className="item">
              <div
                ...
                style={{
                  backgroundImage:
                    "url(assets/images/backgrounds/slider-3-1.jpg)",
                }}
              ></div>
              ...
              <div className="container">
                <div className="main-slider-three__content">
                  ...
                  <p className="main-slider-three__text">
                    ...
                    decade lenitive antique corrupt quo quad molestation
                  </p>
          ...
          <SwiperSlide>
            <div className="item">
              <div
                ...
                style={{
                  backgroundImage:
                    "url(assets/images/backgrounds/slider-3-2.jpg)",
                }}
              ></div>
              <div className="main-slider-three__shape-1">
                <img
          ...
          <SwiperSlide>
            <div className="item">
              <div
                ...
                style={{
                  backgroundImage:
                    "url(assets/images/backgrounds/slider-3-3.jpg)",
                }}
              ></div>
              <div className="main-slider-three__shape-1">
                <img
