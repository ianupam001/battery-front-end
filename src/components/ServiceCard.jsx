  ...
  return (
    <div className="col-lg-6 wow fadeInLeft" data-wow-delay="100ms">
        <div className="services-two__single">
            ...
            <h3 className="services-two__title"><Link to={`/service/${post.slug}`}>{post.title}</Link>
            </h3>
            <p className="services-two__text">{post.short_description}</p>
            <Link to={`/service/${post.slug}`} className="services-two__learn-more">Learn More<span
